...
const Jan_31_21_NetsWizards = () => {


	const dataMock = [
  	{ title: 'BKN 70%', value: 70, color: 'rgb(0, 0, 0)' },
  	{ title: 'WAS 30%', value: 30, color: 'rgb(25, 55, 97)' },
	];
	const dataEspn = [
  	{ title: 'BKN 68.5%', value: 68.5, color: 'rgb(0, 0, 0)' },
  	{ title: 'WSH 31.4%', value: 31.4, color: 'rgb(25, 55, 97)' },
	];
	const dataMock2 = [
  	{ title: 'Under 33%', value: 33, color: 'rgb(0, 0, 0)' },
  	{ title: 'Over 67%', value: 67, color: 'rgb(25, 55, 97)' },
	];
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        Brooklyn Nets vs Washington Wizards
	      ...
	      <div class='leftScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	...
	      	<div style={{fontWeight: '700'}}>13-8 (9-12) ATS</div>
	      </div>
	      <div class='middleScorePanel' style={{}}>
	      	<div class='location'>
	      		<div>January 31, 2021, 7:00 PM ET</div>
	      		<div>Capital One Arena</div>
	      	</div>
	      	<div>Predicted Score</div>
	      	<div style={{marginTop: '40px', height: '100px'}}>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'left', fontWeight: '700'}} >130.9</div>
	      ...
	      <div class='rightScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	...
	      	<div style={{fontWeight: '700'}}>3-12 (6-9) ATS</div>
	      </div>
	    </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> BKN -7.5</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
  		...
  		<div style={{marginTop: '20px', display: 'inline-block', verticalAlign: 'top'}}>
  		  <div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Total Consensus <br /> 245.5 </div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock2}
			      lineWidth={20}
	    ...
	    <div style={{marginTop: '40px'}}>
	    	...
	    	<div style={{display: 'inline-block', width: '300px'}}>
	    	  <div style={{marginBottom: '20px', paddingTop: '20px',fontSize: '24px', fontWeight: '700'}}>Best WAS Spread</div>
...
export default Jan_31_21_NetsWizards;