...
const Feb_8_21_WarriorsSpurs = () => {
	...
	var firstColor = 'rgb(17,64, 158)';
	var secondColor = 'rgb(0,0,0)';


	const dataMock = [
  	{ title: 'GS 43%', value: 43, color: firstColor },
  	{ title: 'SA 57%', value: 57, color: secondColor },
	];
	const dataEspn = [
  	{ title: 'GS 57.0%', value: 57.0, color: firstColor },
  	{ title: 'SA 43.0%', value: 43.0, color: secondColor },
	];
	const dataMock2 = [
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        Golden State Warriors vs San Antonio Spurs
	      ...
	      <div class='middleScorePanel' style={{}}>
	      	...
	      	<div style={{marginTop: '40px', height: '100px'}}>
	      		...
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'right', fontWeight: '700'}} >111.5</div>
	      	</div>
	      </div>
	      <div class='rightScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	<div style={{fontWeight: '700'}}>San Antonio Spurs</div>
	      	<div style={{fontWeight: '700'}}>13-10 (13-10) ATS</div>
	      </div>
	    </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> GS +1.5</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
