...
const Feb_1_21_KingsPelicans = () => {

	var firstColor = 'rgb(83,49,125)';
	var secondColor = 'rgb(11,43,88)';


	const dataMock = [
  	{ title: 'SAC 46%', value: 46, color: firstColor },
  	{ title: 'NOP 54%', value: 54, color: secondColor },
	];
	const dataEspn = [
  	{ title: 'SAC 30.6%', value: 30.6, color: firstColor },
  	{ title: 'NOP 69.4%', value: 69.4, color: secondColor },
	];
	const dataMock2 = [
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        Sacramento Kings vs New Orleans Pelicans
	      ...
	      <div class='leftScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	...
	      	<div style={{fontWeight: '700'}}>8-11 (9-10) ATS</div>
	      </div>
	      <div class='middleScorePanel' style={{}}>
	      	...
	      	<div style={{marginTop: '40px', height: '100px'}}>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'left', fontWeight: '700'}} >117.3</div>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'right', fontWeight: '700'}} >122.9</div>
	      	</div>
	      </div>
	      <div class='rightScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	<div style={{fontWeight: '700'}}>New Orleans Pelicans</div>
	      	<div style={{fontWeight: '700'}}>7-11 (7-11) ATS</div>
	      </div>
	    </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> NOP -3</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
  		...
  		<div style={{marginTop: '20px', display: 'inline-block', verticalAlign: 'top'}}>
  		  <div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Total Consensus <br /> 233 </div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock2}
			      lineWidth={20}
	    ...
	    <div style={{marginTop: '40px'}}>
	    	<div style={{display: 'inline-block', width: '300px'}}>
	    	  <div style={{paddingTop: '20px', marginBottom: '20px', fontSize: '24px', fontWeight: '700'}}>Best SAC Spread</div>
...
export default Feb_1_21_KingsPelicans;