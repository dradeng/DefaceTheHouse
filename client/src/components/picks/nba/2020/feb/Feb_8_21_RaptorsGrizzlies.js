...
const Feb_8_21_RaptorsGrizzlies = () => {

	var firstColor = 'rgb(189,48, 71)';
	var secondColor = 'rgb(97,118,165)';


	const dataMock = [
  	{ title: 'TOR 57.0%', value: 57, color: firstColor },
  	{ title: 'MEM 43.0%', value: 43, color: secondColor },
	];
	const dataEspn = [
  	{ title: 'TOR 68.2%', value: 68.2, color: firstColor },
  	{ title: 'MEM 31.8%', value: 31.8, color: secondColor },
	];
	const dataMock2 = [
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        Toronto Raptors vs Memphis Grizzlies
	      ...
	      <div class='middleScorePanel' style={{}}>
	      	...
	      	<div style={{marginTop: '40px', height: '100px'}}>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'left', fontWeight: '700'}} >115.8</div>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'right', fontWeight: '700'}} >110.9</div>
	      	</div>
	      </div>
	      <div class='rightScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	<div style={{fontWeight: '700'}}>Memphis Grizzlies</div>
	      	<div style={{fontWeight: '700'}}>9-9 (9-8-1) ATS</div>
	      </div>
	    </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> TOR -2</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
...
export default Feb_8_21_RaptorsGrizzlies;