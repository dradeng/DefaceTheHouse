...
const Feb_16_21_LakersTimberwolves = () => {

	var firstColor = 'rgb(85,37, 130)';
	var secondColor = 'rgb(14,55,100)';


	const dataMock = [
  	{ title: 'LAC 45%', value: 45, color: firstColor },
  	{ title: 'MIN 55%', value: 55, color: secondColor },
	];
	const dataEspn = [
  	{ title: 'LAC 74.6%', value: 74.6, color: firstColor },
  	{ title: 'MIN 25.4%', value: 25.4, color: secondColor },
	];
	const dataMock2 = [
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        Los Angeles Lakers vs Minnesota Timberwolves
	      ...
	      <div class='leftScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	...
	      	<div style={{fontWeight: '700'}}>21-7 (13-5) ATS</div>
	      </div>
	      <div class='middleScorePanel' style={{}}>
	      	...
	      	<div style={{marginTop: '40px', height: '100px'}}>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'left', fontWeight: '700'}} >120.0</div>
	      ...
	      <div class='rightScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	...
	      	<div style={{fontWeight: '700'}}>7-20 (14-12-1) ATS</div>
	      </div>
	    </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> MIN +6.5</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
...
export default Feb_16_21_LakersTimberwolves;