...
const Feb_16_21_NetsSuns = () => {

	var firstColor = 'rgb(0,0, 0)';
	var secondColor = 'rgb(248,156,26)';


	const dataMock = [
  	{ title: 'BKN 44%', value: 44, color: firstColor },
  	{ title: 'PHO 56%', value: 56, color: secondColor },
	];
	const dataEspn = [
  	{ title: 'BKN 55.1%', value: 55.1, color: firstColor },
  	{ title: 'PHO 44.9%', value: 44.9, color: secondColor },
	];
	const dataMock2 = [
  	{ title: 'Under 30%', value: 30, color: firstColor },
  	{ title: 'Over 70%', value: 70, color: secondColor },
	];
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        Brooklyn Nets vs Phoenix Suns
	      ...
	      <div class='leftScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	...
	      	<div style={{fontWeight: '700'}}>17-12 (13-16) ATS</div>
	      </div>
	      <div class='middleScorePanel' style={{}}>
	      	<div class='location'>
	      		<div>February 16, 2021,10:30 PM ET</div>
	      		<div>PHX Arena</div>
	      	</div>
	      	<div>Predicted Score</div>
	      	<div style={{marginTop: '40px', height: '100px'}}>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'left', fontWeight: '700'}} >124.7</div>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'right', fontWeight: '700'}} >120.5</div>
	      	</div>
	      </div>
	      <div class='rightScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	<div style={{fontWeight: '700'}}>Phoenix Suns</div>
	      	<div style={{fontWeight: '700'}}>17-9 (17-9) ATS</div>
	      </div>
	    </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> PHO -7.5</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
...
export default Feb_16_21_NetsSuns;