...
const Feb_1_21_KnicksBulls = () => {


	const dataMock = [
  	{ title: 'NY 50%', value: 50, color: 'rgb(231, 137, 63)' },
  	{ title: 'NY 50%', value: 50, color: 'rgb(189, 45, 69)' },
	];
	const dataEspn = [
  	{ title: 'LAL 42.4%', value: 42.4, color: 'rgb(231, 137, 63)' },
  	{ title: 'ATL 57.6%', value: 57.6, color: 'rgb(189, 45, 69)' },
	];
	const dataMock2 = [
  	{ title: 'Under 30%', value: 30, color: 'rgb(231, 137, 63)' },
  	{ title: 'Over 70%', value: 70, color: 'rgb(189, 45, 69)' },
	];
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        New York Knicks vs Chicago Bulls
	      ...
	      <div class='leftScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	...
	      	<div style={{fontWeight: '700'}}>9-12 (10-11) ATS</div>
	      </div>
	      <div class='middleScorePanel' style={{}}>
	      	...
	      	<div style={{marginTop: '40px', height: '100px'}}>
	      		...
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'right', fontWeight: '700'}} >109.3</div>
	      	</div>
	      </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> CHI -4</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
	    ...
	    <div style={{marginTop: '40px'}}>
	    	<div style={{display: 'inline-block', width: '300px'}}>
	    	  <div style={{paddingTop: '20px', marginBottom: '20px', fontSize: '24px', fontWeight: '700'}}>Best NY Spread</div>
...
export default Feb_1_21_KnicksBulls;