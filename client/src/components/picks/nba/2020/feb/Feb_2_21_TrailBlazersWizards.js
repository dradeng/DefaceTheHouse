...
const Feb_2_21_TrailBlazersWizards = () => {

	var firstColor = 'rgb(206,71,69)';
	var secondColor = 'rgb(25,55,97)';


	const dataMock = [
  	{ title: 'POR 48%', value: 48, color: firstColor },
  	{ title: 'WAS 52%', value: 52, color: secondColor },
	];
	const dataEspn = [
  	{ title: 'POR 47.9%', value: 47.9, color: firstColor },
  	{ title: 'WAS 52.1%', value: 52.1, color: secondColor },
	];
	const dataMock2 = [
  	{ title: 'Under 38%', value: 38, color: firstColor },
  	{ title: 'Over 62%', value: 62, color: secondColor },
	];
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        Portland Trail Blazers vs Washington Wizards
	      ...
	      <div class='leftScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	<div style={{fontWeight: '700'}}>Portland Trail Blazers</div>
	      	<div style={{fontWeight: '700'}}>10-9 (8-11) ATS</div>
	      </div>
	      <div class='middleScorePanel' style={{}}>
	      	<div class='location'>
	      		<div>February 02, 2021, 8:00 PM ET</div>
	      ...
	      <div class='rightScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	...
	      	<div style={{fontWeight: '700'}}>4-12 (7-9) ATS</div>
	      </div>
	    </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> WAS -2.5</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
  		...
  		<div style={{marginTop: '20px', display: 'inline-block', verticalAlign: 'top'}}>
  		  <div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Total Consensus <br /> 240.5 </div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock2}
			      lineWidth={20}
	    ...
	    <div style={{marginTop: '40px'}}>
	    	<div style={{display: 'inline-block', width: '300px'}}>
	    	  <div style={{paddingTop: '20px', marginBottom: '20px', fontSize: '24px', fontWeight: '700'}}>Best POR Spread</div>
	    	  ...
	    	  <div style={{paddingTop: '20px', marginBottom: '20px', fontSize: '24px', fontWeight: '700'}}>Best POR Moneyline</div>
	    	  <a href="https://link.intertops.eu/c/408817/" target="_blank" >
...
export default Feb_2_21_TrailBlazersWizards;