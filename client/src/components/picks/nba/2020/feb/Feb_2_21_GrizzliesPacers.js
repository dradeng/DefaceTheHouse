...
const Feb_2_21_GrizzliesPacers = () => {

	var firstColor = 'rgb(97,118,165)';
	var secondColor = 'rgb(10,40,90)';


	const dataMock = [
  	{ title: 'MEM 56%', value: 56, color: firstColor },
  	{ title: 'IND 44%', value: 44, color: secondColor },
	];
	const dataEspn = [
  	{ title: 'MEM 50.4%', value: 50.4, color: firstColor },
  	{ title: 'IND 49.6%', value: 49.6, color: secondColor },
	];
	const dataMock2 = [
  	{ title: 'Under 53%', value: 53, color: firstColor },
  	{ title: 'Over 47%', value: 47, color: secondColor },
	];
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        Memphis Grizzlies vs Indiana Pacers
	      ...
	      <div class='leftScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	...
	      	<div style={{fontWeight: '700'}}>9-6 (9-5-1) ATS</div>
	      </div>
	      <div class='middleScorePanel' style={{}}>
	      	<div class='location'>
	      		<div>February 02, 2021, 8:00 PM ET</div>
	      		<div>BankersLifeFieldhouse</div>
	      	</div>
	      	<div>Predicted Score</div>
	      	<div style={{marginTop: '40px', height: '100px'}}>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'left', fontWeight: '700'}} >110.9</div>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'right', fontWeight: '700'}} >109.7</div>
	      	</div>
	      </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> MEM +4.5</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
	    ...
	    <div style={{marginTop: '40px'}}>
	    	<div style={{display: 'inline-block', width: '300px'}}>
	    	  <div style={{paddingTop: '20px', marginBottom: '20px', fontSize: '24px', fontWeight: '700'}}>Best MEM Spread</div>
...
export default Feb_2_21_GrizzliesPacers;