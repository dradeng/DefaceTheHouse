...
const Feb_8_21_MagicTrailBlazers = () => {

	var firstColor = 'rgb(39, 96, 163)';
	var secondColor = 'rgb(0,0,0)';


	const dataMock = [
  	{ title: 'ORL 40%', value: 40, color: firstColor },
  	{ title: 'POR 60%', value: 60, color: secondColor },
	];
	const dataEspn = [
  	{ title: 'ORL 30.8%', value: 30.8, color: firstColor },
  	{ title: 'POR 69.2%', value: 69.2, color: secondColor },
	];
	const dataMock2 = [
  ...
  return (
    <div style={{textAlign: 'center', margin: '60px 0px'}}>
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        Orland Magic vs Portland Trail Blazers
      </div>
	  	<div>

	      <div class='leftScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	<div style={{fontWeight: '700'}}>Orlando Magic</div>
	      	<div style={{fontWeight: '700'}}>9-15 (10-14) ATS</div>
	      </div>
	      <div class='middleScorePanel' style={{}}>
	      	<div class='location'>
	      		<div>February 09, 2021,10:00 PM ET</div>
	      		<div>Moda Center at the Rose Quarter</div>
	      	</div>
	      	<div>Predicted Score</div>
	      	<div style={{marginTop: '40px', height: '100px'}}>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'left', fontWeight: '700'}} >102.9</div>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'right', fontWeight: '700'}} >114.6</div>
	      	</div>
	      </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> POR -5.5</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
	    ...
	    <div style={{marginTop: '40px'}}>
	    	...
	    	<div style={{display: 'inline-block', width: '300px'}}>
	    	  <div style={{marginBottom: '20px', paddingTop: '20px',fontSize: '24px', fontWeight: '700'}}>Best POR Spread</div>
...
export default Feb_8_21_MagicTrailBlazers;