...
const Feb_1_21_TimberwolvesCavaliers = () => {
	...
	const dataEspn = [
  	{ title: 'MIN 55.2%', value: 55.2, color: firstColor },
  	{ title: 'CLE 44.8%', value: 44.8, color: secondColor },
	];
	const dataMock2 = [
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> CLE -5.5</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
...
export default Feb_1_21_TimberwolvesCavaliers;