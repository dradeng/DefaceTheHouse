...
const Feb_3_21_TimberwolvesSpurs = () => {

	var firstColor = 'rgb(4,23,62)';
	var secondColor = 'rgb(0,0,0)';


	const dataMock = [
  	{ title: 'MIN 33%', value: 33, color: firstColor },
  	{ title: 'SA 67%', value: 67, color: secondColor },
	];
	const dataEspn = [
  	{ title: 'MIN 29.3%', value: 29.3, color: firstColor },
  	{ title: 'SA 70.7%', value: 70.7, color: secondColor },
	];
	const dataMock2 = [
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        Minnesota Timberewolves vs San Antonio Spurs
	      ...
	      <div class='rightScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	...
	      	<div style={{fontWeight: '700'}}>11-10 (12-9) ATS</div>
	      </div>
	    </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> SAN -8.5</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
	    ...
	    <div style={{marginTop: '40px'}}>
	    	...
	    	<div style={{display: 'inline-block', width: '300px'}}>
	    	  <div style={{marginBottom: '20px', paddingTop: '20px',fontSize: '24px', fontWeight: '700'}}>Best SAN Spread</div>
	    	  ...
	    	  <div style={{paddingTop: '20px', marginBottom: '20px', fontSize: '24px', fontWeight: '700'}}>Best SAN Moneyline</div>
	    	  <a href="https://link.intertops.eu/c/408817">
	    	  	<img style={{width: '200px', borderRadius: '8px'}} src={intertops} />
	    	  	<div style={{marginTop: '6px', fontWeight: '700' , color: 'green'}}>
	    	  		-350
...
export default Feb_3_21_TimberwolvesSpurs;