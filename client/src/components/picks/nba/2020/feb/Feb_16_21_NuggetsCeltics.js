...
const Feb_16_21_NuggetsCeltics = () => {

	var firstColor = 'rgb(13,33, 63)';
	var secondColor = 'rgb(0,121,64)';


	const dataMock = [
  	{ title: 'DEN 45%', value: 45, color: firstColor },
  	{ title: 'BOS 55%', value: 55, color: secondColor },
	];
	const dataEspn = [
  	{ title: 'DEN 53.3%', value: 53.3, color: firstColor },
  	{ title: 'BOS 46.7%', value: 46.7, color: secondColor },
	];
	const dataMock2 = [
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        Denver Nuggets vs Boston Celtics
	      ...
	      <div class='leftScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	...
	      	<div style={{fontWeight: '700'}}>15-11 (12-14) ATS</div>
	      </div>
	      <div class='middleScorePanel' style={{}}>
	      	<div class='location'>
	      		<div>February 16, 2021,7:00 PM ET</div>
	      		<div>TD Garden</div>
	      	</div>
	      	...
	      	<div style={{marginTop: '40px', height: '100px'}}>
	      		...
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'right', fontWeight: '700'}} >109.1</div>
	      	</div>
	      </div>
	      <div class='rightScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	<div style={{fontWeight: '700'}}>Boston Celtics</div>
	      	<div style={{fontWeight: '700'}}>13-13 (13-13) ATS</div>
	      </div>
	    </div>
	    ...
	    <div style={{marginTop: '40px'}}>
	    	...
	    	<div style={{display: 'inline-block', width: '300px'}}>
	    	  <div style={{marginBottom: '20px', paddingTop: '20px',fontSize: '24px', fontWeight: '700'}}>Best BOS Spread</div>
...
export default Feb_16_21_NuggetsCeltics;