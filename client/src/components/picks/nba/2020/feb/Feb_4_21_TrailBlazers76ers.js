...
const Feb_4_21_TrailBlazers76ers = () => {

	var firstColor = 'rgb(205,71,69)';
	var secondColor = 'rgb(42,107,176)';


	const dataMock = [
  	{ title: 'POR 59%', value: 59, color: firstColor },
  	{ title: 'PHI 41%', value: 41, color: secondColor },
	];
	const dataEspn = [
  	{ title: 'POR 28.8%', value: 28.8, color: firstColor },
  	{ title: 'PHI 71.2%', value: 71.2, color: secondColor },
	];
	const dataMock2 = [
  	{ title: 'Under 31%', value: 69, color: firstColor },
  	{ title: 'Over 31%', value: 69, color: secondColor },
	];
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        Portland Trail Blazers vs Philadelphia 76ers
	      ...
	      <div class='leftScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	...
	      	<div style={{fontWeight: '700'}}>11-9 (9-11) ATS</div>
	      </div>
	      <div class='middleScorePanel' style={{}}>
	      	<div class='location'>
	      		<div>February 04, 2021,8:00 PM ET</div>
	      		<div>Wells Fargo Center</div>
	      	</div>
	      	<div>Predicted Score</div>
	      	<div style={{marginTop: '40px', height: '100px'}}>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'left', fontWeight: '700'}} >108.3</div>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'right', fontWeight: '700'}} >119.0</div>
	      	</div>
	      </div>
	      <div class='rightScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	<div style={{fontWeight: '700'}}>Philadelphia 76ers</div>
	      	<div style={{fontWeight: '700'}}>16-6 (12-8-2) ATS</div>
	      </div>
	    </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> POR +8.5</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
	    ...
	    <div style={{marginTop: '40px'}}>
	    	...
	    	<div style={{display: 'inline-block', width: '300px'}}>
	    	  <div style={{marginBottom: '20px', paddingTop: '20px',fontSize: '24px', fontWeight: '700'}}>Best PHI Spread</div>
...
export default Feb_4_21_TrailBlazers76ers;