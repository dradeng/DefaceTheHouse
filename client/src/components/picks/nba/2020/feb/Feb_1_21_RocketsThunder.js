...
const Feb_1_21_RocketsThunder = () => {

	var firstColor = 'rgb(195,41,47)';
	var secondColor = 'rgb(223,92,64)';


	const dataMock = [
  	{ title: 'HOU 39%', value: 39, color: firstColor },
  	{ title: 'OKC 61%', value: 61, color: secondColor },
	];
	const dataEspn = [
  	{ title: 'HOU 59.1%', value: 59.1, color: firstColor },
  	{ title: 'OKC 40.9%', value: 40.9, color: secondColor },
	];
	const dataMock2 = [
  	{ title: 'Under 31%', value: 31, color: firstColor },
  	{ title: 'Over 69%', value: 69, color: secondColor },
	];
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        Houston Rockets vs Oklahoma City Thunder
	      ...
	      <div class='leftScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	...
	      	<div style={{fontWeight: '700'}}>9-9 (8-10) ATS</div>
	      </div>
	      <div class='middleScorePanel' style={{}}>
	      	<div class='location'>
	      		<div>February 01, 2021, 8:00 PM ET</div>
	      		<div>Chesapeake Energy Arena</div>
	      	</div>
	      	<div>Predicted Score</div>
	      	<div style={{marginTop: '40px', height: '100px'}}>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'left', fontWeight: '700'}} >116.3</div>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'right', fontWeight: '700'}} >109.9</div>
	      	</div>
	      </div>
	      <div class='rightScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	<div style={{fontWeight: '700'}}>Oklahoma City Thunder</div>
	      	<div style={{fontWeight: '700'}}>8-10 (10-8) ATS</div>
	      </div>
	    </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> OKC +5</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
	    ...
	    <div style={{marginTop: '40px'}}>
	    	...
	    	<div style={{display: 'inline-block'}}>
	    		<div>
	    		  <div style={{marginBottom: '20px', fontSize: '24px', paddingTop: '20px', fontWeight: '700'}}>Best Over (233)</div>
	    	  ...
	    	  <div style={{}}>
	    	  	<div style={{paddingTop: '20px', marginBottom: '20px', fontSize: '24px', fontWeight: '700'}}>Best Under (233)</div>
		    	  <a href="https://link.intertops.eu/c/408817">
		    	  	<img style={{width: '200px', borderRadius: '8px'}} src={intertops} />
		    	  	<div style={{marginTop: '6px', fontWeight: '700' , color: 'green'}}>
	    	  			-110
...
export default Feb_1_21_RocketsThunder;