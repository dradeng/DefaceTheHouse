...
const Feb_4_21_JazzHawks = () => {
	...
	const dataMock = [
  	{ title: 'UTA 55%', value: 55, color: firstColor },
  	{ title: 'ATL 45%', value: 45, color: secondColor },
	];
	const dataEspn = [
  	{ title: 'UTA 62.4%', value: 62.4, color: firstColor },
  	{ title: 'ATL 37.6%', value: 37.6, color: secondColor },
	];
	const dataMock2 = [
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        Utah Jazz vs Atlanta Hawks
	      ...
	      <div class='leftScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	...
	      	<div style={{fontWeight: '700'}}>16-5 (14-6-1) ATS</div>
	      </div>
	      <div class='middleScorePanel' style={{}}>
	      	...
	      	<div style={{marginTop: '40px', height: '100px'}}>
	      		...
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'right', fontWeight: '700'}} >105.2</div>
	      	</div>
	      </div>
	      <div class='rightScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	<div style={{fontWeight: '700'}}>Atlanta Hawks</div>
	      	<div style={{fontWeight: '700'}}>10-11 (11-10) ATS</div>
	      </div>
	    </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> UTA -7.5</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
...
export default Feb_4_21_JazzHawks;