...
const Feb_3_21_KnicksBulls = () => {
	...
	const dataMock = [
  	{ title: 'NY 46%', value: 46, color: firstColor },
  	{ title: 'CHI 54%', value: 54, color: secondColor },
	];
	const dataEspn = [
  	{ title: 'NY 44.0%', value: 44.0, color: firstColor },
  	{ title: 'CHI 56.0%', value: 56.0, color: secondColor },
	];
	const dataMock2 = [
  	{ title: 'Under 46%', value: 46, color: firstColor },
  	{ title: 'Over 54%', value: 54, color: secondColor },
	];
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        New York Knicks vs Chicago Bulls
	      ...
	      <div class='middleScorePanel' style={{}}>
	      	...
	      	<div style={{marginTop: '40px', height: '100px'}}>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'left', fontWeight: '700'}} >106.6</div>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'right', fontWeight: '700'}} >111.2</div>
	      	</div>
	      </div>
	      <div class='rightScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	<div style={{fontWeight: '700'}}>Chicago Bulls</div>
	      	<div style={{fontWeight: '700'}}>8-11 (12-7) ATS</div>
	      </div>
	    </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> CHI -2</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
...
export default Feb_3_21_KnicksBulls;