...
const Feb_16_21_TrailBlazersThunder = () => {
	...
	const dataMock = [
  	{ title: 'POR 60%', value: 60, color: firstColor },
  	{ title: 'OKC 40%', value: 40, color: secondColor },
	];
	const dataEspn = [
  	{ title: 'POR 56.5%', value: 56.5, color: firstColor },
  	{ title: 'OKC 43.5%', value: 43.5, color: secondColor },
	];
	const dataMock2 = [
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        Portland Trail Blazers vs Oklahoma City Thunder
	      ...
	      <div class='leftScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	<div style={{fontWeight: '700'}}>Portlan Trail Blazers</div>
	      	<div style={{fontWeight: '700'}}>16-10 (14-12) ATS</div>
	      </div>
	      <div class='middleScorePanel' style={{}}>
	      	...
	      	<div style={{marginTop: '40px', height: '100px'}}>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'left', fontWeight: '700'}} >116.7</div>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'right', fontWeight: '700'}} >114.5</div>
	      	</div>
	      </div>
	      <div class='rightScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	<div style={{fontWeight: '700'}}>Oklahoma City Thunder</div>
	      	<div style={{fontWeight: '700'}}>11-15 (15-10-1) ATS</div>
	      </div>
	    </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> POR -5</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
...
export default Feb_16_21_TrailBlazersThunder;