...
const Feb_4_21_NuggetsLakers = () => {
	...
	var firstColor = 'rgb(79,44,126)';
	var secondColor = 'rgb(18,34,61)';


	const dataMock = [
  	{ title: 'DEN 44%', value: 44, color: firstColor },
  	{ title: 'LAL 56%', value: 56, color: secondColor },
	];
	const dataEspn = [
  	{ title: 'DEN 36.5%', value: 36.5, color: firstColor },
  	{ title: 'LAL 63.5%', value: 63.5, color: secondColor },
	];
	const dataMock2 = [
      ...
      <div style={{fontSize: '40px', fontWeight: '700', marginBottom: '40px'}}>
        Denver Nuggets vs Los Angeles Lakers
	      ...
	      <div class='leftScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	...
	      	<div style={{fontWeight: '700'}}>12-8 (10-10) ATS</div>
	      </div>
	      <div class='middleScorePanel' style={{}}>
	      	<div class='location'>
	      		<div>February 04, 2021, 10:00 PM ET</div>
	      		<div>Staples Center</div>
	      	</div>
	      	<div>Predicted Score</div>
	      	<div style={{marginTop: '40px', height: '100px'}}>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'left', fontWeight: '700'}} >110.4</div>
	      		<div class='predictedScore' style={{display: 'inline-block', float: 'right', fontWeight: '700'}} >108.9</div>
	      	</div>
	      </div>
	      <div class='rightScorePanel' style={{display: 'inline-block', verticalAlign: 'top'}}>
	      	<div style={{fontWeight: '700'}}>Los Angeles Lakers</div>
	      	<div style={{fontWeight: '700'}}>16-6 (11-11) ATS</div>
	      </div>
	    </div>
	    ...
	    <div style={{display: 'inline-block', marginTop: '20px', verticalAlign: 'top'}}>
	    	<div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Spread Consensus <br /> LAL -5.5</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock}
			      lineWidth={20}
  		...
  		<div style={{marginTop: '20px', display: 'inline-block', verticalAlign: 'top'}}>
  		  <div style={{width: '280px', margin: '0px 20px'}}>
	  			<div style={{fontSize: '24px', fontWeight: '700', marginBottom: '20px'}}>Total Consensus <br /> 216.5</div>
	  			<PieChart
	  				style={{height: '200px'}}
			      data={dataMock2}
			      lineWidth={20}
	    ...
	    <div style={{marginTop: '40px'}}>
	    	...
	    	<div style={{display: 'inline-block'}}>
	    		<div>
	    		  <div style={{marginBottom: '20px', fontSize: '24px', paddingTop: '20px', fontWeight: '700'}}>Best Over (216.5)</div>
	    	  ...
	    	  <div style={{}}>
	    	  	<div style={{paddingTop: '20px', marginBottom: '20px', fontSize: '24px', fontWeight: '700'}}>Best Under (216.5)</div>
		    	  <a href="https://link.intertops.eu/c/408817">
		    	  	<img style={{width: '200px', borderRadius: '8px'}} src={intertops} />
		    	  	<div style={{marginTop: '6px', fontWeight: '700' , color: 'green'}}>
	    	  			-110
...
export default Feb_4_21_NuggetsLakers;